                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select required name="direccion" id="direccion" class="selectpicker show-tick form-control" data-live-search="true">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select required name="dependencia" id="dependencia" class="selectpicker show-tick form-control" data-live-search="true">
