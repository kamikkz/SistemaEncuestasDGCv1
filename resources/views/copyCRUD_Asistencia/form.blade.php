        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-header">Nuevo asistente</div>
                    <div class="card-body">
                        @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    @csrf
                    <div class="card-header">Inscribir al curso:<strong> {{$cursos->name}}</strong></div>
                    <div class="card-body">
                        <input type="hidden" value="{{$cursos->id}}" name="fkcurso" id="fkcurso">
                        <div class="form-group row">
                            <label for="direccion" class="col-form-label text-md-right">Nombre de Usuario</label>
                    ...
                    <div class="card-footer">
                        {!! Form::submit('Inscribir al curso',['class'=>'btn btn-primary form-control'])!!}
                    </div>
                    {!! Form::close() !!}
                </div>
            </div>
